...
objects = $(TARGET_DIR)/simu_main.o $(TARGET_DIR)/uartsim.o $(TARGET_DIR)/remote_bitbang.o \
		  $(TARGET_DIR)/verilated_vcd_c.o $(TARGET_DIR)/verilated.o $(TARGET_DIR)/verilated_dpi.o
...
$(TARGET_DIR)/uartsim.o: uartsim.cpp $(TARGET_DIR)
	@echo 'Building file: $<'
	@echo 'Invoking: $(CC) C Compiler'
	$(CC) $(CFLAGS)  $< -o $@
	@echo 'Finished building: $<'
...
$(TARGET_DIR)/remote_bitbang.o: remote_bitbang.cpp $(TARGET_DIR)
	@echo 'Building file: $<'
	@echo 'Invoking: $(CC) C Compiler'
	$(CC) $(CFLAGS)  $< -o $@
	@echo 'Finished building: $<'
