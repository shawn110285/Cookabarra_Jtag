...
/*----------------------------------- inst rom ---------------------------------*/
`define RomNum                  1024  //2k
`define RomNumLog2              10    //11 bits addr

/*----------------------------------- data ram ---------------------------------*/
`define RamNum                  2048  //2k
`define RamNumLog2              11    //12 bits addr
...
/* --------------config parameters -----------*/
`define  REBOOT_ADDR              32'h00000080         //  32'h80 for c-test program, 32'h00000000: for isa test
